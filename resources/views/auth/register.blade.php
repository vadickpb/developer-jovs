...
<div class="container mx-auto max-w-screen-md">
    <div class="flex flex-wrap justify-center">
        ...
        <div class="md:w-1/2 order-1  px-10 mt-10 md:order-2 text-center flex flex-col justify-center">
            <h1 class="text-teal-500 text-4xl">¿Eres un reclutador?</h1>
            <p class="text-xl mt-5 leading-7">Crea una cuenta totalmente gratis y comienta a publicar
                hasta 10 vacantes
            </p>
        </div>
