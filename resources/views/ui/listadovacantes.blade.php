        ...
        <ul class="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <li class="p-10 border border-gray-300 bg-white shadow">
                ...
                <a class="bg-teal-500 text-gray-100 mt-2 px-4 py-2 inline-block rounded font-bold text-sm hover:bg-teal-700" href="{{ route('vacantes.show', ['vacante' => $vacante->id]) }}">Ver Vacante</a>
            </li>
            @endforeach
